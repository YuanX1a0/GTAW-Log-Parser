...
- **多翻译引擎** — 支持 Google、DeepSeek、DeepL、豆包（火山方舟）、Zoom，以及**自定义 AI 服务（OpenAI 兼容接口）**，内置 200+ 服务商预设（DeepSeek、OpenRouter、硅基流动、Moonshot、阿里百炼、豆包、Anthropic、Gemini、Ollama 等）。选择服务商 + 输入 API Key 自动读取模型列表，修改后即时生效。
